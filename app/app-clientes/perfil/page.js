...
// - "Personalizar menú" es distinto en App Clientes: no hay accesos
//   directos opcionales (ATAJOS_MENU) como en App Interno -- el único
//   reordenamiento es el drag & drop de las 3 pestañas del menú
//   superior (item 4), así que acá es solo un texto que señala eso, no
//   el componente PersonalizarMenu de App Interno (no aplica, es un
//   mecanismo distinto).
      ...
      <div className="page" style={{ paddingTop: 24 }}>
        ...
        <div className="card">
          <p style={{ fontSize: 13, color: "var(--texto-suave)", margin: 0 }}>
            Mantén presionado y arrastra los botones del menú de arriba (Registro, Listado de clientes, Listado de órdenes) para ordenarlos a tu gusto. Inicio y Más siempre quedan fijos en su lugar.
          </p>
        </div>
      </div>
    </div>
