...
// Editar seguimiento -- llena progresivamente los campos que van pasando
// con la orden (envío a, fechas de retorno/listo/entrega, verificado por,
// factura). Cada guardado anota el cambio en el historial (Titular) y
// recalcula el estado solo, según lib/ordenes-estado.js.
  ...
  return (
    <div>
      ...
      <div className="page" style={{ paddingTop: 24 }}>
        ...
        />
        <h1 className="page-title">Editar seguimiento</h1>
