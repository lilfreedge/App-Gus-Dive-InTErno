...
// Para columnas `date` puras (yyyy-mm-dd, sin hora, ej. proxima_inspeccion
// / proximo_mantenimiento) — a diferencia de las de arriba, NO pasa por
// Intl con zona horaria: un `date` no tiene hora, y convertir
// "2027-09-12" a America/Santo_Domingo (UTC-4) lo interpretaría como
// medianoche UTC y lo movería al día anterior. Aquí simplemente se
// reparten los componentes del string.
export function formatFechaDDMMAAAADeDate(fechaISO) {
  if (!fechaISO) return "";
